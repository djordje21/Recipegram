...
class CreateReputationSystem < ActiveRecord::Migration[4.2]
  def self.up
    ...
    add_index :rs_evaluations, %i[target_id target_type]
    add_index :rs_evaluations, %i[source_id source_type]
    ...
    add_index :rs_reputations, %i[target_id target_type]
    ...
    add_index :rs_reputation_messages, %i[sender_id sender_type]
